...
def get_filters():
    ...
    while True:    
        month = input("Please enter which month you want to know about")
        month = month.lower()
...
def user_stats(df, city):
    ...
    if city != 'washington':
        ...
        print("Earliest year of birth is ", eyob, "\n")
        print("Recent year of birth is ", mryob, "\n")
        print("Common year of birth is ", mcyob, "\n")
